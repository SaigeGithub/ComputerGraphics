...
void outPut(){
    ...
    myfile << cam_pos_points[0].position()[0] << endl;
    myfile << cam_pos_points[0].position()[1] << endl;
    myfile << cam_pos_points[0].position()[2] << endl;

    myfile << cam_pos_points[1].position()[0] << endl;
    myfile << cam_pos_points[1].position()[1] << endl;
    myfile << cam_pos_points[1].position()[2] << endl;

    myfile << cam_pos_points[2].position()[0] << endl;
    myfile << cam_pos_points[2].position()[1] << endl;
    myfile << cam_pos_points[2].position()[2] << endl;

    myfile << cam_pos_points[3].position()[0] << endl;
    myfile << cam_pos_points[3].position()[1] << endl;
    myfile << cam_pos_points[3].position()[2] << endl;
    myfile.close();
    //return 0;
